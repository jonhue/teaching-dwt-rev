...
\begin{frame}{Messbarkeitstheorie}
    \begin{definition}
        ...
        \end{itemize}
    \end{definition}\pause
    \begin{example}[Beispiele messbarer Funktionen]
        \begin{itemize}
